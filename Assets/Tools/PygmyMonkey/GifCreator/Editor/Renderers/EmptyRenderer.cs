...
namespace PygmyMonkey.GifCreator
{
	public class EmptyRenderer
	{
		...
		private void destroyRecorder()
		{
			if (gifCreatorWindow.Parameters.camera != null)
			{
                UnityEngine.Component.DestroyImmediate(gifCreatorWindow.Parameters.camera.GetComponent<Recorder>());
                UnityEngine.Component.DestroyImmediate(gifCreatorWindow.Parameters.camera.GetComponent<CustomRectPreview>());
			}

			if (lastCamera != null)
			{
                UnityEngine.Component.DestroyImmediate(lastCamera.GetComponent<Recorder>());
                UnityEngine.Component.DestroyImmediate(lastCamera.GetComponent<CustomRectPreview>());
			}

			if (Recorder.Singleton != null)
			{
                UnityEngine.Component.DestroyImmediate(Recorder.Singleton);
			}
		}
		...
		public void OnDestroy()
		{
			...
			if (CustomRectPreview.Singleton != null)
			{
                UnityEngine.Component.DestroyImmediate(CustomRectPreview.Singleton);
			}
		}
